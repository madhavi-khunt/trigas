...
import TrigasLogo from "../assets/logos/whitelogo.png";
import CustomerView from "../components/Table/CustomerView";
  ...
  return (
    <Box sx={{ display: "flex" }}>
      ...
      >
        ...
        <Link to="/customer" style={{ textDecoration: "none", color: "#fff" }}>
          <List>
            {["Customers"].map((text) => (
